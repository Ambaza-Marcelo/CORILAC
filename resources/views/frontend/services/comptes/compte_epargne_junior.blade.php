...
<html lang="en">
  <head>
    <title>Compte dՎpargne junior</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5">
            ...
            <img src="{{ asset('frontend/images/undraw_true_friends.svg')}}" alt="" class="img-fluid">
            </figure>
          </div>
          <div class="col-lg-5 ml-auto">
            
            <h1 class="text-black mb-4">Compte dՎpargne junior</h1>
