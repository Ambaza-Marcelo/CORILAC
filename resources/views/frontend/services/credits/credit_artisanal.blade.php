      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto">
            ...
            <h1 class="text-black mb-4">CREDIT ARTISANAL</h1>

            <p>CREDIT ARTISANAL est un crédit à court terme vous permettant de financer vos besoins d'urgence.
            </p>  
          </div>
        </div> 
        <div class="row">
