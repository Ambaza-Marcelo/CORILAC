     ...
     <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                <img src="{{ asset('frontend/images/undraw_message.svg') }}" width="250">
                <form method="POST" action="{{ route('admin.login.submit') }}">
                    @csrf
                    <div class="login-form-head">
                      <!--  <h4>Sign In</h4> -->
                        <p>
                             <img src="{{ asset('frontend/images/logo_CORILAC.png') }}" alt="logo Musumba" width="100" height="20">
                        </p>
                    </div>
                ...
                <img src="{{ asset('frontend/images/undraw_access.svg') }}" width="250">
            </div>
        </div>
    </div>
    <!-- login area end -->
