        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.sms_banking.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('Sms banking')</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body bg-success">
                    <h4 class="header-title">Sms banking</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.sms_banking.update',$sms_banking->id) }}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
