                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input autofocus type="url" class="form-control" name="facebook" value="{{$setting->facebook}}" required minlength="6" maxlength="255">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="gasape">Gasape<span class="text-danger"></span></label>
                                        <input autofocus type="url" class="form-control" name="gasape" value="{{$setting->gasape}}" required minlength="6" maxlength="255">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="linkedln">Linkedln<span class="text-danger"></span></label>
                                        <input autofocus type="url" class="form-control" name="linkedln" value="{{$setting->linkedln}}" required minlength="5" maxlength="255">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
